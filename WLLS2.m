function [ dis , dcord , angle ] = WLLS2 ( x , y , d , var )
...
%La función devolverá un vector cuya componente:
%1: la distancia de la antena al agente en cuestión
%2: las coordenadas [ x y ] del agente
%3: ángulo del agente segín la referencia 
j=1;
for i = 1:4
